#ifndef UDP_REL_ECHO_CLIENT_H
#define UDP_REL_ECHO_CLIENT_H
...
class UdpRelEchoClient : public Application 
{
public:
  /**
...
private:
  ...
  uint32_t lastAck = -1;
  uint32_t firstTimeReceivedNum = 0;
  uint32_t retransNum = 0;
  uint32_t receivedRetrans = 0;
  uint32_t lossNum = 0;
  bool isStop = false;
  // ===================================================================
