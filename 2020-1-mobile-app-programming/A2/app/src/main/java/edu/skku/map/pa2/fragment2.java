...
public class fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String id_val = getArguments().getString("id_val");
        final View view = inflater.inflate(R.layout.fragment_fragment2, container, false);
        afterfunc2 afterfuncfunc2 = new afterfunc2() {
            @Override
            public void afterfuncfunc2(ArrayList<MyItem> items) {
                ...
                Log.d("View",String.format("%d", items.size()));
        ...
        setData(afterfuncfunc2, id_val);
        return view;
    }

    private void setData(final afterfunc2 afterfuncfunc2, String id_val){
        ...
        Query query = postRef.whereEqualTo("username", id_val).whereEqualTo("ispersonal", 1);
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        Log.d("ser", (String)document.getData().get("contents"));
                        items.add(item);
                    }
                    afterfuncfunc2.afterfuncfunc2(items);
                } else {
...
interface afterfunc2{
    void afterfuncfunc2(ArrayList<MyItem> items);
}